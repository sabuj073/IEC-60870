...
{
    printf("%02i:%02i:%02i %02i/%02i/%04i", CP56Time2a_getHour(time),  //print time stamp
...
#if 0
    if (strcmp(ipAddress, "127.0.0.1") == 0) {    //allowing ip
...
main(int argc, char** argv)
{
    ...
    */
    CS104_Slave_setServerMode(slave, CS104_MODE_SINGLE_REDUNDANCY_GROUP);   /* Server mode is selected*/
