...
interrogationHandler(void* parameter, IMasterConnection connection, CS101_ASDU asdu, uint8_t qoi)
{
    ...
    if (qoi == 20) { /* only handle station interrogation */
        ...
        IMasterConnection_sendACT_CON(connection, asdu, false);   //to send the interrogated data back to the client/master
...
int
main(int argc, char** argv)     //main or driver program
{
    /* Add Ctrl-C handler */
    ...
    uint64_t nextSendTime = Hal_getTimeInMs() + 1000;  //is platform independent way to get the current time as milliseconds
